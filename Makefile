...
ft_putchar.c ft_putendl_fd.c ft_putnbr_fd.c ft_putnbr.c ft_putstr_fd.c \
ft_putstr.c ft_strcat.c ft_strchr.c ft_strclr.c ft_strcmp.c ft_strcpy.c \
ft_strdel.c ft_strdup.c ft_streau.c ft_striter.c ft_striteri.c ft_strjoin.c \
...
$(NAME):
	gcc -I. -c $(SRC) -Wall -Wextra -Werror
	ar rc $(NAME) $(OBJ)
	ranlib $(NAME)
